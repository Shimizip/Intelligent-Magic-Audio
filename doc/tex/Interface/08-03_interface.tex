...
Das Lesen der Namen der Samples und Übertragen in den \boldinline{FileManager} auf den Flash Speicher der MCU hat geklappt und hat somit eine Visualisierung auf dem Display ermöglicht.
