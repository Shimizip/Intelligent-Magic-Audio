...
\textbf{Teillösung:} \\
Das Lesen der Namen der Samples und Übertragen in den \boldinline{FileManager} hat geklappt und hat somit eine Visualisierung auf dem Display ermöglicht.
