...
\textbf{Schiebepotentiometer} erfassen analoge Spannungen, die vom \textbf{Analog-Digital-Wandler (ADC)} in digitale Werte umgewandelt werden\textbf{\autoref{fig:fig:conversion}}. Er nimmt in regelmäßigen Intervallen Proben des analogen Signals. Die Auflösung in 12 Bits 15 ADC Clock Cycles hat sich als am effizientesten herrausgestelt. ()\textbf{Wertebereich} 0-4096).
...
Der Direct Memory Access (DMA)-Controller übernimmt die Datenübertragung direkt zwischen dem Speicher und Peripheriegeräten, wodurch der Prozessor von diesen Aufgaben entlastet wird. Analoge-Digital-Wandler (ADCs) ermöglichen die zeitnahe Digitalisierung von analogen Signalen, was eine präzise Verarbeitung der Messwerte sicherstellt. Potentiometer ermöglichen eine benutzerfreundliche Anpassung von Spannungswerten. Das Bussystem gewährleistet eine effiziente Kommunikation zwischen den verschiedenen Komponenten und trägt zu einer konsistenten und zuverlässigen Datenverarbeitung bei. \textbf{\autoref{fig:DMA_ADC_FADER}} \\
