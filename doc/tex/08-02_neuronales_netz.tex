...
Insgesamt wurden 209 Audiosamples unterschiedlicher Länge mit Labels versehen. Diese wurden in 2.837 Audiosubsamples aufgeteilt. Für das eigentliche Training wurden 1.701 Datensätze verwendet. Eine Visualisierung der Datenaufteilung ist in \textbf{\autoref{fig:img-input-data-graph}} abgebildet.

\begin{figure}[h!]
\centering
\includegraphics[width=0.95\textwidth]{images/08_durchfuehrung/input-data-graph.png}
\caption{Aufteilung der Eingabedaten in Trainings- Validierungs- und Testdaten}
