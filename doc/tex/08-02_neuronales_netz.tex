...
Aus den in \ref{sec:input-data-generation} erwähnten 209 gelabelten Audiosamples wurden durch deren Aufteilung insgesamt 2.837 Audiosubsamples gewonnen.
...
Wie in \ref{sec:input-data-generation} beschrieben, wurden 209 Audiosamples mit Labeln versehen. Diese  in 2.837 Audiosubsamples aufgeteilt. Für das Training des neuronalen Netzes werden die Daten wie üblich in Trainingsdaten, Validierungsdaten und Testdaten aufgeteilt.
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.95\textwidth]{images/08_durchfuehrung/input-data-graph.png}
...
\begin{wrapfigure}{r}{0.4\textwidth} % Increase the width of the figure environment
	...
	\fbox{\includegraphics[width=0.4\textwidth]{images/08_durchfuehrung/nn_learning_curve.png}}
